...
- 首次使用参见 [五分钟 Quickstart](02-五分钟快速开始.md)
- 角色配置参见 [推荐的 Agent 协作拓扑](03-智能体协作拓扑.md)
- 安全边界参见 [安全模型与已知风险](19-安全模型与已知风险.md)
- 完整状态设计参见 [控制状态、事件与状态投影](13-控制目录事件与状态投影.md)
